...
const ENTRIES: PortalBackgroundEntry[] = [
  ...
  { path: "/student/absence", src: SENMON_IMAGES.kankyoReception.src, alt: SENMON_IMAGES.kankyoReception.alt },
  ...
  { path: "/student/photos", src: SENMON_IMAGES.photo7.src, alt: SENMON_IMAGES.photo7.alt },
  { path: "/student/insurance", src: KOUTOU_DETAIL.shisetsuBaba.src, alt: KOUTOU_DETAIL.shisetsuBaba.alt },
  { path: "/student/tuition", src: SENMON_IMAGES.banner6.src, alt: SENMON_IMAGES.banner6.alt },
  ...
  { path: "/parent/absence", src: SENMON_IMAGES.kankyoOffice.src, alt: SENMON_IMAGES.kankyoOffice.alt },
  ...
  { path: "/parent/photos", src: KOUTOU_IMAGES.photo1.src, alt: KOUTOU_IMAGES.photo1.alt },
  { path: "/parent/insurance", src: KOUTOU_DETAIL.shisetsuKyusha.src, alt: KOUTOU_DETAIL.shisetsuKyusha.alt },
  { path: "/parent/tuition", src: SENMON_IMAGES.banner6.src, alt: SENMON_IMAGES.banner6.alt },
