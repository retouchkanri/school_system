  ...
  return (
    <div className="pointer-events-none fixed inset-y-0 right-0 z-50 flex flex-col items-end justify-center gap-2 pr-2">
      ...
      >
        ...
        <span className="font-serif flex flex-col items-center text-[13px] font-bold leading-[1.2] text-white">
          <span>L</span>
          <span>I</span>
          <span>N</span>
          <span>E</span>
      ...
      >
        <span
          className="font-serif text-[13px] font-bold tracking-[0.2em] text-white"
