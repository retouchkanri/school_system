...
import { submitAbsenceRequest, type AbsenceActionState } from "./actions";
...
export default function AbsenceForm({ defaultDate }: { defaultDate: string }) {
  const [state, formAction, pending] = useActionState<AbsenceActionState, FormData>(submitAbsenceRequest, {});
  ...
  return (
    <form action={formAction} className="space-y-4">
      ...
      <Field label="補足">
        <textarea name="detail" rows={2} className={inputCls} placeholder="例: 午後から登校できる見込みです。" />
      </Field>
